...
M.non_c_line_comments_by_filetype = {
    lua = "--",
    python = "#",
    sql = "--",
}

function M.comment_out(opts)
    local line_comment = M.non_c_line_comments_by_filetype[vim.bo.filetype] or "//"
